...
private:
    ...
    std::atomic<int> findingArena;
    std::atomic<int> arenaConfirmed;
    std::atomic<int> arenaInStock;
    std::atomic<int> sendingPosition;
    std::atomic<int> positionStopped;
    std::atomic<int> watchdogON;
    std::atomic<int> stopRobot;
    ...
    RT_SEM sem_confirmation;
    RT_SEM sem_arenaDone; 
    RT_SEM sem_positionDone;
    ...
    /**
     * @brief Thread handling the battery.
     */
